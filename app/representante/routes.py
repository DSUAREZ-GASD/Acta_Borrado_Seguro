...
@representantes.route('/crear', methods=['GET', 'POST'])
...
def crear():
    ...
    return render_template('representante/crear.html', form=form)

# Listado de representantes
@representantes.route('/lista', methods=['GET'])
@acceso_requerido(roles=["Administrador"])
@login_required
def lista():
    try:
        representantes = Representante.query.all()
        return render_template('representante/lista.html', representantes=representantes)
    except Exception as e:
...
def editar(representante_id):
    ...
    return render_template('representante/editar.html', form=form_edit, representante=representante)             
